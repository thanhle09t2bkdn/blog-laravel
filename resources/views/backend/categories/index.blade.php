                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body table-responsive p-0">
                            <form method="POST" action="{{ route('backend.categories.delete') }}" id="form-delete-items">
                                @method('DELETE')
                                @csrf
                                    ...
                                    @forelse ($list as $item)
                                        <tr class="ui-state-default">
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('backend.categories.show', $item->id) }}" class="btn btn-sm btn-info">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <a href="{{ route('backend.categories.edit', $item->id) }}" class="btn btn-sm btn-warning">
